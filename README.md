# 📄 Bates-Labeler - Easily Add Bates Numbers to PDFs
...
4. **Install the Application**:
   ...
   - For **Mac/Linux**: Extract the downloaded file to access the application. You may need to use the terminal for running the command. 
...
### 🌐 Web Interface
1. Launch the application by clicking on the icon or executing the file.
2. Choose the PDF documents you want to work on.
3. Configure your Bates numbering format and any additional features you want to use.
4. Click the button to begin processing your documents.
